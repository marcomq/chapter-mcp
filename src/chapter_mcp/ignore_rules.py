...
IgnoreRule = tuple[bool, bool, bool, str]
...
class IgnoreMatcher:
    ...
    def _directories_for(self, path: Path, category_dir: Path) -> tuple[Path, ...]:
        ...
        current = category_dir.parent if category_dir.is_file() else path.parent
...
def _matches_ignore_rule(*, pattern: str, relative_path: str, anchored: bool, directory_only: bool) -> bool:
